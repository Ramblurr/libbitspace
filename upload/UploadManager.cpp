...
namespace bitspace
{
    ...
    Upload* UploadManager::upload( const QString & file_path )
    {
        ...
        return new Upload( bitspace::nam()->post( header, ba), m_session, this );
    }

    bool UploadManager::isValid() const
    {
        return true;
    }

    void UploadManager::slotNewSession()
    {
        qDebug() << "UploadManager::slotNewSession()";
        if( !m_sessionReply )
            return;
...
//    void UploadManager::slotUploadFinished()
//    {
//        qDebug() << "UploadManager::slotUploadFinished()";
...
//    }
//    void UploadManager::slotNotifyFinished()
//    {
...
//    }
//
//    void UploadManager::slotError( QNetworkReply::NetworkError error )
//    {
//        qDebug() << "Error: " << error << m_uploadReply->errorString();
//        emit uploadError( m_uploadReply->errorString() );
//    }
//
//    void UploadManager::slotAbort()
//    {
